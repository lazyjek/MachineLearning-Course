...
import random
random.seed(0)
from data_provider import data_parser, data_provider
...
class CrossValidate(object):
    ...
    def fold(self, fold, shuffle = True):
        ...
        testInstances, testLabels = data_parser(testData)
        trainInstances, trainLabels = data_parser(trainData)
        return (trainInstances, trainLabels), (testInstances, testLabels)
